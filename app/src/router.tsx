...
import Translate from "@/routes/Translate.tsx"; // 1. 引入新页面

const Model = lazyFactor(() => import("@/routes/Model.tsx"));
const Preset = lazyFactor(() => import("@/routes/Preset.tsx"));
const MiniApps = lazyFactor(() => import("@/routes/MiniApps.tsx"));
const UqaLanding = lazyFactor(() => import("@/routes/UqaLanding.tsx"));
const UqaQuestionnaire = lazyFactor(() => import("@/routes/UqaQuestionnaire.tsx"));
const UqaResult = lazyFactor(() => import("@/routes/UqaResult.tsx"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        id: "uqa-questionnaire",
        path: "uqa/questionnaire",
        element: (
          <Suspense>
            <UqaQuestionnaire />
          </Suspense>
